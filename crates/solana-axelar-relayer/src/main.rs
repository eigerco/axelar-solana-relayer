...
async fn main() {
    ...
    let gateway_task_processor = solana_gateway_task_processor::SolanaTxPusher::new(
        ...
        solana_gateway_task_processor::PriorityFeeGasEstimator::new(estimation_rpc_url),
    );
    ...
    let rest_service_component = rest_service::RestService::new(&config.rest_service);
...
mod tests {
    ...
    fn parse_toml() -> eyre::Result<()> {
        ...
        let max_concurrent_http_requests = 10_i32;
